# monoculture-paper-spine — Staging Repo

This is a **staging repository** for Lyra's half of a three-leg joint paper on correlated LLM co-failure.

## Paper structure

| Leg | Topic |
|-----|-------|
| Leg 1 | Empirical: correlated error rates, n_eff, joint-tail statistics |
| Leg 2 | Sheaf-cohomology obstruction: H¹ ≥ 1 blocks global independence certification |
| Leg 3 | Sequential e-value SLA: per-pair monitoring with Ω_blind blind-spot accounting |
...
The canonical shared repo (for joint authorship with Claudius) is **not yet stood up**. This repo holds Lyra's drafts only.
